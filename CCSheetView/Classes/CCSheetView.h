...
@protocol FMSheetViewDelegate <UITableViewDelegate>
@required
...
@interface CCSheetView : UITableView <FMSheetTVCellScrollNotifyDelegate, CCSheetTVHeaderScrollNotifyDelegate>

@property (nonatomic, weak, nullable) id <FMSheetViewDelegate> delegate;

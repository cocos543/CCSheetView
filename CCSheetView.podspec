...
Pod::Spec.new do |s|
  s.name             = 'CCSheetView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CCSheetView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Cocos/CCSheetView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Cocos543' => '543314602@qq.com' }
  s.source           = { :git => 'https://github.com/Cocos/CCSheetView.git', :tag => s.version.to_s }
